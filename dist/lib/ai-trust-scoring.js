...
exports.assessImmediateRisk = assessImmediateRisk;
...
function assessImmediateRisk(trustScore, currentLocation, expectedZone, activeTask) {
...
function generateRiskReport(factors) {
